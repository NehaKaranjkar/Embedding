...
from noisyopt import minimize_discrete_SPSA
...
def Run_discrete_SPSA():
    ...
    for l in range(len(simulation_budget)) :
        ...
        for trial in range(NUM_TRIALS):
            ...
            res  = minimize_discrete_SPSA(func=OP.ObjectiveFunction, 
				x0=x_start,
                                bounds=OP.bounds,
                                paired=False,
                                niter=500,
    ...
    fname = "RESULTS_discrete_SPSA.py"
...
def Summarize_results():
    result_filename = "RESULTS_discrete_SPSA"
    imp = __import__(result_filename)
    R = imp.RESULTS
    
    fname = "RESULTS_discrete_SPSA_summary.txt"
